  ...
  return (
    <section className="relative w-screen h-screen max-h-[850px] min-h-[750px]">
      ...
      <Container className="h-full bg-primary-800 flex items-center justify-center">
        <div className="text-center flex flex-col items-center gap-4 z-10 max-w-xs md:max-w-xl">
          ...
          <div className="flex flex-col md:flex-row gap-[10px] w-full px-3 md:gap-6">
