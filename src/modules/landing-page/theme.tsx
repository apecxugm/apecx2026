const Theme = () => {
  return (
    <section id="theme" className="w-screen bg-primary-900 flex items-center justify-center">
      <div className="relative w-full max-w-[1328px] aspect-[398/640] md:aspect-[1328/640] bg-center bg-cover mx-4 md:mx-0 my-10" style={{ backgroundImage: "url('/dummy.webp')" }}>
